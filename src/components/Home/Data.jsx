...
const Data = () => {
  const [text] = useTypewriter({
    words: ['Data Analyst', "Frontend Developer", "Backend Developer","Freelancer"],
    loop: {},
    typeSpeed: 120,
    deleteSpeed: 80,
...
const pullContact=()=>{
  ...
  return (
    <div className="home_data">
      <h1 className="home_title"> Niranjan
      ...
      <p className="home_description">
        I’m a creative data analyst who loves solving real-world problems with data, uncovering insights through code, and turning numbers into smart decisions
     I</p>
